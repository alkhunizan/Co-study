...
[English Documentation](./README.md) · [نظام التصميم](./design-system/README.md)

**هلا ستدي** (سابقًا كو-ستدي) هي غرفة المذاكرة الهادئة، الدافئة، المفتوحة طول الليل — تطبيق body-doubling لطلاب الخليج. ادخل، شغّل الكاميرا، أوقف المايك، واشتغل مع غيرك. مبنية عربيًا أولًا، مع دعم RTL كامل.

هذه النسخة مهيأة للسعودية وتدعم:
- العربية كلغة افتراضية مع تخطيط RTL كامل
- الإنجليزية كلغة إضافية قابلة للتبديل
- حفظ تفضيل اللغة عبر `coStudyLang`
- خصائص CSS منطقية في جميع أنحاء التطبيق لقلب التخطيط تلقائيًا عند تغيير اللغة
