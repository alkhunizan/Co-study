...
**هلاستدي** (سابقًا كو-ستدي) هي غرفة المذاكرة الهادئة، الدافئة، المفتوحة طول الليل — تطبيق body-doubling لطلاب الخليج. ادخل، شغّل الكاميرا، أوقف المايك، واشتغل مع غيرك. مبنية عربيًا أولًا، مع دعم RTL كامل.
